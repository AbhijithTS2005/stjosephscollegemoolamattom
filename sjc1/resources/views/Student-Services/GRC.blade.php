...
@section('content')
    <div class="page-container">
        <div class="content-column">
            <h1 class="section-header">Grievance Redressal Cell</h1>
            
            <p class="content-text">
                The Grievance Redressal Cell addresses and resolves student grievances and complaints through a systematic process. The cell ensures fair, transparent, and timely resolution of all complaints related to academic and non-academic matters.
            </p>
