...
@section('content')
    <div class="page-container">
        <div class="content-column">
            <h1 class="section-header">National Cadet Corps (NCC)</h1>
            
            <p class="content-text">
                The National Cadet Corps (NCC) at St. Joseph's College Moolamattom is a youth organization that develops character, discipline, and patriotism among students. Through military training and character building, NCC prepares students to be responsible citizens and leaders.
            </p>

            <p class="content-text">
                Our NCC unit offers training in various aspects including drill, weapon training, disaster management, and social service. Students engage in national camps, competitions, and community service activities that foster a sense of duty towards the nation.
            </p>

            <a href="#" class="action-btn">
                <i class="fas fa-file-pdf"></i> View NCC Document
            </a>
        </div>
