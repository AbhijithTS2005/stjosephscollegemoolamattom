...
@section('content')
    <div class="page-container">
        <div class="content-column">
            <h1 class="section-header">ASAP</h1>
            
            <p class="content-text">
                ASAP is a student support program designed to provide academic assistance and mentoring to students requiring additional help. The program focuses on improving academic performance and ensuring student success.
            </p>
