...
@section('content')
    <div class="page-container">
        <div class="content-column">
            <h1 class="section-header">Endowments</h1>
            
            <p class="content-text">
                Endowments are financial resources allocated to support deserving students through scholarships and financial aid. These funds promote educational excellence and ensure talented students from economically weak backgrounds can pursue their studies without financial constraints.
            </p>
