...
@section('content')
    <div class="page-container">
        <div class="content-column">
            <h1 class="section-header">College Students' Union</h1>
            
            <p class="content-text">
                The College Students' Union represents the voice of the student community and works to address student concerns and organize various activities. It plays a crucial role in student governance and advocacy.
            </p>
