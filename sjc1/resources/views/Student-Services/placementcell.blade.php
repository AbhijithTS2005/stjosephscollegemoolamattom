...
@section('content')
    <div class="page-container">
        <div class="content-column">
            <h1 class="section-header">Placement Cell</h1>
            
            <p class="content-text">
                The Career Guidance and Placement Cell helps students prepare for suitable careers. Seminars and interactive sessions are organized to disseminate information on higher education options and specific career sectors. Special training is given in Interview preparation, Resume writing, and professional grooming.
            </p>
