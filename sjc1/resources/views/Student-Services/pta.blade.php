...
@section('content')
    <div class="page-container">
        <div class="content-column">
            <h1 class="section-header">PTA</h1>
            
            <p class="content-text">
                The Parent-Teacher Association serves as a bridge between parents, teachers, and administration. It promotes collaboration and communication to enhance the overall educational experience and development of students.
            </p>
