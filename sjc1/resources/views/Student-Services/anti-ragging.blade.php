...
@section('content')
    <div class="page-container">
        <div class="content-column">
            <h1 class="section-header">Anti-Ragging Cell</h1>
            
            <p class="content-text">
                The Anti-Ragging Cell is committed to creating a safe and conducive environment for all students by preventing and addressing instances of ragging. The cell ensures all students can pursue their education without fear or harassment.
            </p>
