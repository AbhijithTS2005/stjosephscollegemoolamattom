...
@section('content')
    <div class="page-container">
        <div class="content-column">
            <h1 class="section-header">WWS</h1>
            
            <p class="content-text">
                The WelWish Support program provides comprehensive support services including counseling, mentoring, and guidance. It aims to foster overall development and well-being of the student community.
            </p>
