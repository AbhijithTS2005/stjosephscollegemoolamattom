...
@section('content')
    <div class="page-container">
        <div class="content-column">
            <h1 class="section-header">Students Aid Fund Scheme</h1>
            
            <p class="content-text">
                The Students Aid Fund Scheme provides financial assistance to needy students of the college. Students can apply in response to notifications made every year, with mentors playing a crucial role in identifying eligible students.
            </p>
