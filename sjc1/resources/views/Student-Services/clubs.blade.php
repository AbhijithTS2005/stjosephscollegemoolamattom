...
@section('content')
    <div class="page-container">
        <div class="content-column">
            <h1 class="section-header">Clubs & Forums</h1>
            
            <p class="content-text">
                Clubs and Forums provide students with opportunities to explore their talents, build communities, and engage in activities of their interest. These organizations foster leadership, teamwork, and personal development while promoting cultural and intellectual growth.
            </p>
