...
@section('content')
    <div class="page-container">
        <div class="content-column">
            <h1 class="section-header">SC, ST, OBC Cell</h1>
            
            <p class="content-text">
                The SC, ST, OBC Cell promotes the special interests of reserved category students and guides them to utilize government benefit schemes. The cell provides special support in areas where students experience difficulties.
            </p>
