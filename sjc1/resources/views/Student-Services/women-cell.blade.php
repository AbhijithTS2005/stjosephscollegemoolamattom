...
@section('content')
    <div class="page-container">
        <div class="content-column">
            <h1 class="section-header">Women Cell</h1>
            
            <p class="content-text">
                The Women Cell is dedicated to promoting the welfare and interests of women students. It provides support, guidance, and resources to ensure a safe and empowering environment for all women on campus.
            </p>
