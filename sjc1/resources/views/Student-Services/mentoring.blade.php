...
@section('content')
    <div class="page-container">
        <div class="content-column">
            <h1 class="section-header">Mentoring System</h1>
            
            <p class="content-text">
                Every student is assigned to the care of a Mentor for personal attention and guidance. Students can consult their mentor on all matters and seek advice intended to help solve their difficulties. Mentors maintain close contact with guardians and keep them informed of student progress.
            </p>
