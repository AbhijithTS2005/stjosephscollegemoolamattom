        ...
        <main>
            <div class="content-block">
                <div class="course-header">
                    <h1>B.Com (Computer Applications)</h1>
                </div>
                
                <p>
                    The B.Com (Computer Applications) program integrates commerce education with practical computer applications. Students develop expertise in business software, data management, and IT systems, preparing them for careers in corporate information systems, business analysis, and technology-driven finance.
                </p>
                
                <div class="info-box">
                    <h3 style="color: var(--college-blue); margin-bottom: 10px;">Duration & Structure</h3>
                    <p>3-year undergraduate program with 6 semesters integrating commerce with IT applications.</p>
                </div>
                
                <h3 style="color: var(--college-blue); margin: 20px 0 15px 0;">Specialization Areas</h3>
                <ul style="margin-left: 20px;">
                    <li>Business Software and ERP Systems (SAP, Tally)</li>
                    <li>Database Management and SQL</li>
                    <li>E-Commerce and Digital Marketing</li>
                    <li>Financial Analysis using Excel and BI Tools</li>
                    <li>Web Development and IT Infrastructure</li>
                </ul>
                
                <div class="info-box">
                    <h3 style="color: var(--college-blue); margin-bottom: 10px;">Technical Skills</h3>
                    <p>Students gain hands-on training in programming languages, database administration, cloud computing, and enterprise resource planning systems essential for modern business operations.</p>
                </div>
                
                <h3 style="color: var(--college-blue); margin: 20px 0 15px 0;">Career Prospects</h3>
                <p>Graduates can pursue careers as Software Developers, Business Analysts, Database Administrators, IT Consultants, or ERP Specialists in IT companies and corporate information departments.</p>
            </div>
        </main>
