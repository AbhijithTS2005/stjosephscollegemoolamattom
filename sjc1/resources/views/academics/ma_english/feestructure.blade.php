...
<style>
    * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', sans-serif; }
    ...
    .fee-item strong { color: var(--college-blue); }
    ...
    <div class="container">
        <main>
            <div class="content-block">
                ...
                <p>Below is the detailed fee structure for the {{ ucfirst($course) }} course program.</p>
                
                <h3 style="color: var(--college-blue); margin: 20px 0 15px 0;">Tuition Fees</h3>
                
                <div class="fee-item">
                    <strong>Annual Tuition Fee:</strong> Amount per academic year (may vary based on category/merit)
                </div>
                
                <div class="fee-item">
                    <strong>Semester Fee:</strong> Amount per semester (if applicable)
                </div>
                
                <h3 style="color: var(--college-blue); margin: 20px 0 15px 0;">Other Fees</h3>
                
                <div class="fee-item">
                    <strong>Laboratory/Practical Fee:</strong> For courses with practical components
                </div>
                
                <div class="fee-item">
                    <strong>Library Fee:</strong> Annual library and resource access fee
                </div>
                
                <div class="fee-item">
                    <strong>Activity/Sports Fee:</strong> For participation in sports and activities
                </div>
                
                <div class="fee-item">
                    <strong>Examination Fee:</strong> Per semester examination fee
                </div>
                
                <h3 style="color: var(--college-blue); margin: 20px 0 15px 0;">Payment Terms</h3>
                <ul style="margin-left: 20px; margin-top: 10px;">
                    <li>Fees payable semester-wise or annually as per college policy</li>
                    <li>Installment options available (subject to approval)</li>
                    <li>Payment deadline: As per academic calendar</li>
                    <li>Late fee applicable for delayed payments</li>
                </ul>
                
                <p style="margin-top: 20px;"><em>Note: Fee structure is subject to change. Please check with the finance office for current applicable fees.</em></p>
            </div>
        </main>
