        ...
        <main>
            <div class="content-block">
                <div class="course-header">
                    <h1>M.Com (Finance & Taxation)</h1>
                </div>
                
                <p>
                    The M.Com (Finance & Taxation) program is a postgraduate degree designed for professionals seeking specialized expertise in advanced finance, taxation, and financial management. The curriculum prepares students for senior positions in financial institutions and corporate finance roles.
                </p>
                
                <div class="info-box">
                    <h3 style="color: var(--college-blue); margin-bottom: 10px;">Duration & Structure</h3>
                    <p>2-year postgraduate program with 4 semesters focusing on advanced financial management and taxation.</p>
                </div>
                ...
                <ul style="margin-left: 20px;">
                    ...
                    <li>Corporate Finance and Investment Analysis</li>
                ...
                <div class="info-box">
                    <h3 style="color: var(--college-blue); margin-bottom: 10px;">Research & Development</h3>
                    <p>Students engage in research projects on contemporary finance and taxation issues, working with faculty on real-world financial problems and policy analysis.</p>
                </div>
                
                <h3 style="color: var(--college-blue); margin: 20px 0 15px 0;">Career Prospects</h3>
                <p>Graduates pursue careers as Financial Analysts, Investment Managers, Tax Consultants, CFOs, Corporate Finance Managers, or pursue further doctoral research.</p>
            </div>
        </main>
