    ...
    <div class="container">
        <main>
            <div class="content-block">
                ...
                <p>
                    The B.A Economics program provides comprehensive education in economic theory, analysis, and policy. Students develop analytical skills for understanding economic systems and solving real-world problems.
                </p>
                
                <div class="info-box">
                    <h3 style="color: var(--college-blue); margin-bottom: 10px;">Duration & Structure</h3>
                    <p>3-year undergraduate program with 6 semesters covering microeconomics, macroeconomics, and applied economics.</p>
                </div>
                
                <h3 style="color: var(--college-blue); margin: 20px 0 15px 0;">Key Features</h3>
                <ul style="margin-left: 20px;">
                    <li>Economic theory and quantitative analysis</li>
                    <li>Data analysis and econometrics</li>
                    <li>Policy analysis and research projects</li>
                ...
                <p>Graduates can work as Economists, Policy analysts, Financial consultants, or in government and international organizations.</p>
            </div>
        </main>
