        ...
        <main>
            <div class="content-block">
                <div class="course-header">
                    <h1>B.Com (Finance & Taxation)</h1>
                </div>
                
                <p>
                    The B.Com (Finance & Taxation) program is designed to equip students with specialized knowledge in accounting, financial management, and taxation laws. Students develop expertise in financial analysis, auditing, and tax compliance, preparing them for careers in finance, accounting, and taxation.
                </p>
                
                <div class="info-box">
                    <h3 style="color: var(--college-blue); margin-bottom: 10px;">Duration & Structure</h3>
                    <p>3-year undergraduate program with 6 semesters specializing in finance and taxation.</p>
                </div>
                
                <h3 style="color: var(--college-blue); margin: 20px 0 15px 0;">Specialization Areas</h3>
                <ul style="margin-left: 20px;">
                    <li>Advanced Accounting and Financial Management</li>
                    <li>Income Tax and Corporate Tax Laws</li>
                    <li>Financial Analysis and Valuation</li>
                    <li>Auditing and Internal Controls</li>
                    <li>Banking and Financial Institutions</li>
                </ul>
                
                <div class="info-box">
                    <h3 style="color: var(--college-blue); margin-bottom: 10px;">Professional Certifications</h3>
                    <p>Program aligns with CA (Chartered Accountant), CS (Company Secretary), and CMA (Cost Management Accountant) entrance examinations, preparing students for these prestigious professional designations.</p>
                </div>
                
                <h3 style="color: var(--college-blue); margin: 20px 0 15px 0;">Career Prospects</h3>
                <p>Graduates can work as Chartered Accountants, Financial Analysts, Tax Consultants, Auditors, Investment Advisors, or Banking Professionals in corporate and financial institutions.</p>
            </div>
        </main>
