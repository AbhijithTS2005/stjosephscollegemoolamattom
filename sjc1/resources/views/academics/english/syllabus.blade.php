...
<style>
    * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', sans-serif; }
    ...
    .course-card h4 { color: var(--college-blue); margin-bottom: 8px; }
    ...
    <div class="container">
        <main>
            <div class="content-block">
                <h1 class="page-title">Syllabus & Courses</h1>
                
                <p>The syllabus outlines all the courses and their detailed content for the {{ ucfirst($course) }} program.</p>
                
                <h3 style="color: var(--college-blue); margin: 20px 0 15px 0;">Semester-wise Courses</h3>
                
                <div class="course-card">
                    <h4>First Semester</h4>
                    <p>Core courses providing foundational knowledge and essential concepts for the program.</p>
                </div>
                
                <div class="course-card">
                    <h4>Second Semester</h4>
                    <p>Courses building upon the first semester with intermediate level topics.</p>
                </div>
                
                <div class="course-card">
                    <h4>Third Semester</h4>
                    <p>Advanced courses focusing on specialized topics and practical applications.</p>
                </div>
                
                <h3 style="color: var(--college-blue); margin: 20px 0 15px 0;">Course Details</h3>
                ...
                <ul style="margin-left: 20px; margin-top: 10px;">
                    ...
                    <li>Detailed syllabus content</li>
                    <li>Recommended textbooks and references</li>
                    <li>Assessment methods</li>
                </ul>
                
                <p style="margin-top: 20px;"><em>For detailed syllabus of individual courses, please download the complete syllabus document.</em></p>
            </div>
        </main>
