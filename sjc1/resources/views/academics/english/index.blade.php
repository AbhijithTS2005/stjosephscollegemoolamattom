    ...
    <div class="container">
        <main>
            <div class="content-block">
                ...
                <p>
                    The B.A English program cultivates advanced language skills, literary analysis, and critical thinking abilities. Students explore diverse literary traditions, language studies, and communication skills.
                </p>
                
                <div class="info-box">
                    <h3 style="color: var(--college-blue); margin-bottom: 10px;">Duration & Structure</h3>
                    <p>3-year undergraduate program with 6 semesters covering literature, language, and communication.</p>
                </div>
                
                <h3 style="color: var(--college-blue); margin: 20px 0 15px 0;">Key Features</h3>
                <ul style="margin-left: 20px;">
                    <li>Study of British, American, and Indian literature</li>
                    <li>Language skills and communication training</li>
                    <li>Creative writing and research skills</li>
                    <li>Digital literacy and media studies</li>
                    <li>Preparation for publishing and academia</li>
                </ul>
                
                <h3 style="color: var(--college-blue); margin: 20px 0 15px 0;">Career Prospects</h3>
                <p>Graduates can work as writers, editors, journalists, teachers, content creators, or in publishing and media industries.</p>
            </div>
        </main>
