        ...
        <main>
            <div class="content-block">
                <div class="course-header">
                    <h1>Master of Social Work (MSW)</h1>
                </div>
                
                <p>
                    The MSW program prepares students for professional social work practice emphasizing community development, clinical work, and policy advocacy. Students develop skills to address social issues and help vulnerable populations.
                </p>
                
                <div class="info-box">
                    <h3 style="color: var(--college-blue); margin-bottom: 10px;">Duration & Structure</h3>
                    <p>2-year postgraduate program with 4 semesters covering social work theory, practice, and fieldwork.</p>
                </div>
                
                <h3 style="color: var(--college-blue); margin: 20px 0 15px 0;">Key Features</h3>
                <ul style="margin-left: 20px;">
                    <li>Social work theory and methods</li>
                    <li>Community development and grassroots programs</li>
                    <li>Field work and internships with NGOs</li>
                    <li>Counseling and clinical skills training</li>
                    <li>Research and policy studies</li>
                </ul>
                
                <h3 style="color: var(--college-blue); margin: 20px 0 15px 0;">Career Prospects</h3>
                <p>Graduates can work with NGOs, government agencies, health institutions, or as independent social workers addressing social welfare and development issues.</p>
            </div>
        </main>
