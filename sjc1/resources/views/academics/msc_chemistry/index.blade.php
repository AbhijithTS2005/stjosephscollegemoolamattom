    ...
    <div class="container">
        <main>
            <div class="content-block">
                ...
                <p>
                    The M.Sc Chemistry program is a comprehensive postgraduate degree designed to provide advanced knowledge in diverse areas of chemistry. Students gain expertise in organic, inorganic, physical, and analytical chemistry with emphasis on research methodology and practical applications.
                </p>
                
                <div class="info-box">
                    <h3 style="color: var(--college-blue); margin-bottom: 10px;">Duration & Structure</h3>
                    <p>2-year postgraduate program with 4 semesters including coursework, seminars, and research projects.</p>
                </div>
                
                <h3 style="color: var(--college-blue); margin: 20px 0 15px 0;">Specialization Areas</h3>
                <ul style="margin-left: 20px;">
                    <li>Organic Chemistry and Synthesis</li>
                    <li>Inorganic Chemistry and Catalysis</li>
                    <li>Physical Chemistry and Spectroscopy</li>
                    <li>Analytical Chemistry and Instrumentation</li>
                    <li>Environmental Chemistry</li>
                    <li>Industrial Chemistry Applications</li>
                </ul>
                
                <div class="info-box">
                    <h3 style="color: var(--college-blue); margin-bottom: 10px;">Research Opportunities</h3>
                    <p>Students conduct original research under faculty guidance using modern laboratory facilities and analytical instruments, leading to thesis publication and conference presentations.</p>
                </div>
                
                <h3 style="color: var(--college-blue); margin: 20px 0 15px 0;">Career Prospects</h3>
                <p>Graduates pursue careers in pharmaceutical research, chemical industries, environmental consulting, quality control, or pursue doctoral studies in chemistry and related fields.</p>
            </div>
        </main>
