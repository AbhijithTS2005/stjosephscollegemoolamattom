    ...
    <div class="container">
        <main>
            <div class="content-block">
                ...
                <p>
                    The B.Sc Mathematics program provides rigorous training in pure and applied mathematics. Students develop strong analytical and problem-solving skills through advanced mathematical concepts and their applications.
                </p>
                
                <div class="info-box">
                    <h3 style="color: var(--college-blue); margin-bottom: 10px;">Duration & Structure</h3>
                    <p>3-year undergraduate program with 6 semesters covering pure and applied mathematics.</p>
                </div>
                
                <h3 style="color: var(--college-blue); margin: 20px 0 15px 0;">Key Features</h3>
                <ul style="margin-left: 20px;">
                    <li>Strong foundation in pure mathematics</li>
                    <li>Applied mathematics and computational methods</li>
                    <li>Programming and numerical analysis</li>
                    <li>Research projects and seminars</li>
                    <li>Preparation for advanced studies and research</li>
                </ul>
                
                <h3 style="color: var(--college-blue); margin: 20px 0 15px 0;">Career Prospects</h3>
                <p>Graduates can pursue careers in education, research, finance, IT, actuarial science, and data analysis.</p>
            </div>
        </main>
