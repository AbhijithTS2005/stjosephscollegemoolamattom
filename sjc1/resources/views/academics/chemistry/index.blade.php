    ...
    <div class="container">
        <main>
            <div class="content-block">
                ...
                <p>
                    The B.Sc Chemistry program offers comprehensive education in organic, inorganic, physical, and analytical chemistry. Students gain practical laboratory skills and theoretical knowledge essential for chemistry professionals.
                </p>
                
                <div class="info-box">
                    <h3 style="color: var(--college-blue); margin-bottom: 10px;">Duration & Structure</h3>
                    <p>3-year undergraduate program with 6 semesters including classroom lectures and extensive laboratory work.</p>
                </div>
                
                <h3 style="color: var(--college-blue); margin: 20px 0 15px 0;">Key Features</h3>
                <ul style="margin-left: 20px;">
                    <li>Well-equipped chemistry laboratories</li>
                    <li>Hands-on practical training in all branches of chemistry</li>
                    <li>Research projects and industrial exposure</li>
                    <li>Expert faculty with research publications</li>
                ...
                <p>Graduates can work as Chemists, Quality Control analysts, Research Scientists, Pharmaceutical professionals, or Environmental consultants.</p>
            </div>
        </main>
