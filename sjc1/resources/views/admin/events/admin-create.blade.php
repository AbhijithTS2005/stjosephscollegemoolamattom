...
<div class="form-container">
    <div class="form-header">
        <div style="display: flex; align-items: center; gap: 10px;">
            <i class="fas fa-shield-alt" style="font-size: 1.5rem; color: var(--college-blue);"></i>
            <div>
                <h1>{{ isset($event) ? 'Edit Event' : 'Create New Event' }}</h1>
                <div class="subtitle"><strong>Admin Panel</strong> - Manage all college events</div>
            </div>
        </div>
        ...
        <form action="{{ isset($event) ? route('events.update', $event) : route('events.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-row">
                ...
                <div class="form-group {{ $errors->has('status') ? 'has-error' : '' }}">
                    ...
                    <select name="status">
                        <option value="approved" {{ old('status', $event->status ?? 'approved') == 'approved' ? 'selected' : '' }}>Approved (Published)</option>
            ...
            <div class="form-actions">
                <button type="submit" class="btn btn-primary">
                    <i class="fas fa-save"></i> {{ isset($event) ? 'Update Event' : 'Create Event' }}
                </button>
