...
<div class="form-container">
    <div class="form-header">
        <div style="display: flex; align-items: center; gap: 10px;">
            ...
            <div>
                ...
                <div class="subtitle">
                    <strong>@deptDisplay($userDepartment) Department</strong> - Manage your department events
                    <span class="dept-badge">@deptDisplay($userDepartment)</span>
                </div>
            </div>
        </div>
        <a href="{{ route('dept.events.index', $userDepartment) }}" class="form-back-link">
    ...
    <div class="info-box">
        ...
        <strong>All events you create are automatically published</strong> and visible on your department's event page.
    </div>
    ...
    <div class="form-section">
        <form action="{{ isset($event) ? route('events.update', $event) : route('events.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-actions">
                ...
                <a href="{{ route('dept.events.index', $userDepartment) }}" class="btn btn-secondary">
