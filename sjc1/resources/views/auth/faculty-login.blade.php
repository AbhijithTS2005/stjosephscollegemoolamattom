        ...
        <div class="login-card">
            <div style="text-align: center;">
                <span class="faculty-badge">
                    <i class="fas fa-user-tie"></i> Faculty Manage Login
                </span>
            </div>

            <h2>Welcome</h2>
            <p class="login-subtitle">Access faculty management and information</p>
            ...
            <div class="help-section">
                <p><strong><i class="fas fa-info-circle"></i> Need Help?</strong></p>
                <p>Contact your department head or the IT office if you forgot your password.</p>
                <p style="margin-top: 8px;"><strong>Portal Features:</strong> View profile, manage information, access resources</p>
            </div>
