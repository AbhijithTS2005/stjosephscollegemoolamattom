    ...
    <div class="container">
        <main>
            <div class="content-block">
                <h1 class="page-title">Quality Assurance Reports</h1>
                
                <div class="info-box">
                    <p>Comprehensive reports on institutional quality assurance activities, findings, and recommendations for continuous improvement.</p>
                </div>

                <h3>Types of Reports</h3>
                <ul>
                    <li><strong>Annual Quality Assurance Report (AQAR):</strong> Comprehensive annual documentation of quality metrics and activities</li>
                    <li><strong>Department Quality Reports:</strong> Subject-wise quality assessment reports</li>
                    <li><strong>Internal Audit Reports:</strong> Regular quality audits and compliance checks</li>
                    <li><strong>Student Satisfaction Survey Reports:</strong> Analysis of student feedback</li>
                    <li><strong>Learning Outcome Assessment Reports:</strong> Evaluation of student learning outcomes</li>
                    <li><strong>Accreditation Preparation Reports:</strong> NAAC and other accreditation readiness reports</li>
                </ul>

                <h3>Available Reports</h3>
                <p>Recent quality assurance reports:</p>
                <ul>
                    <li><a href="#">Quality Assurance Report 2023-2024</a></li>
                    <li><a href="#">Department Assessment Report 2023-2024</a></li>
                    <li><a href="#">Student Satisfaction Survey 2024</a></li>
                    <li><a href="#">Learning Outcome Assessment 2024</a></li>
                    <li><a href="#">Internal Quality Audit Report 2024</a></li>
                </ul>

                <h3>Report Components</h3>
                <p>Quality reports typically include:</p>
                <ul>
                    ...
                    <li>Action Plans and Recommendations</li>
                    <li>Implementation Timeline</li>
                    <li>Supporting Data and Evidence</li>
                </ul>

                <h3>Report Dissemination</h3>
                <p>Quality reports are shared with:</p>
                <ul>
                    <li>Academic departments</li>
                    <li>Administrative staff</li>
                    <li>Student councils</li>
                    <li>Parent associations</li>
                    <li>Regulatory and accreditation bodies</li>
                    <li>General public (where applicable)</li>
                </ul>
            </div>
        </main>
        ...
        <aside class="sidebar">
            <div class="sidebar-section">
                ...
                <ul class="sidebar-links">
                    ...
                    <li><a href="{{ route('iqac.reports') }}" class="active-link"><i class="fas fa-chart-bar"></i> Reports</a></li>
