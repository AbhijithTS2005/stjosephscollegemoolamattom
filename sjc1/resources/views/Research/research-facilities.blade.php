...
<div class="page-container">
    <div class="content-column">
        ...
        <p>
            St. Joseph's College provides adequate infrastructure to support quality research.
        </p>

        <ul>
            <li>Well-equipped laboratories</li>
            <li>ICT-enabled classrooms</li>
            <li>Central and departmental libraries</li>
            <li>Access to e-resources and databases</li>
            <li>Facilities for data analysis and documentation</li>
        </ul>
    </div>
