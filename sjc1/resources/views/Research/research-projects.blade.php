...
<div class="page-container">
    <div class="content-column">
        ...
        <p>
            Faculty and students at St. Joseph's College are engaged in diverse research projects addressing contemporary challenges and advancing knowledge.
        </p>

        <ul>
            <li>Funded research projects from government agencies (DST, DBT, ICMR, etc.)</li>
            <li>Industry-sponsored research collaborations</li>
            <li>Inter-disciplinary research initiatives</li>
            <li>Student-led research projects</li>
            <li>Applied research for social impact</li>
