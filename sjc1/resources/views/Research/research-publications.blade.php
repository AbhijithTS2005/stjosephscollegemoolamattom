...
<div class="page-container">
    <div class="content-column">
        ...
        <p>
            Research outcomes at St. Joseph's College are regularly disseminated through peer-reviewed journals, conferences, and scholarly platforms.
        </p>

        <ul>
            <li>Journal articles in indexed and peer-reviewed publications</li>
            <li>Conference proceedings and presentations</li>
            <li>Book chapters and edited volumes</li>
            <li>Research reports and technical papers</li>
            <li>Open-access repository of faculty publications</li>
            <li>Institutional repository for thesis and dissertations</li>
        </ul>
    </div>
