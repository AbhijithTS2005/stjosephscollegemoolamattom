...
<div class="page-container">
    <div class="content-column">
        ...
        <p>
            St. Joseph's College supports a vibrant community of research scholars engaged in advancing knowledge and innovation.
        </p>

        <ul>
            <li>PhD scholars working on cutting-edge research topics</li>
            <li>Post-doctoral researchers and visiting scholars</li>
            <li>Master's students engaged in thesis research</li>
            <li>Undergraduate researchers in departmental research programs</li>
            <li>Research scholarships and fellowships for deserving scholars</li>
            <li>Opportunities for international research collaborations</li>
        </ul>
    </div>
