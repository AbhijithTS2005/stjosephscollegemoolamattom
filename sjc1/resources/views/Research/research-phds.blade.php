...
<div class="page-container">
    <div class="content-column">
        ...
        <p>
            St. Joseph's College offers doctoral programs across various disciplines, fostering advanced research and academic excellence.
        </p>

        <ul>
            <li>Doctoral research programs in multiple departments</li>
            <li>Mentorship from experienced faculty researchers</li>
            <li>Access to research facilities and resources</li>
            <li>Funding opportunities for doctoral research</li>
            <li>Regular seminars and research colloquia</li>
            <li>Support for conference participation and publications</li>
        </ul>
    </div>
