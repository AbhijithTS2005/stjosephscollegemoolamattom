...
<div class="page-container">
    <div class="content-column">
        ...
        <p>
            St. Joseph's College regularly hosts seminars, workshops, and colloquia to foster intellectual exchange and disseminate research findings.
        </p>

        <ul>
            <li>Regular departmental seminars and research colloquia</li>
            <li>Guest lectures from renowned researchers and academics</li>
            <li>Interdisciplinary symposia and workshops</li>
            <li>Training workshops on research methodologies and tools</li>
            <li>Student research presentation forums</li>
            <li>International and national conference participations</li>
        </ul>
    </div>
