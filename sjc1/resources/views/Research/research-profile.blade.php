...
<div class="page-container">
    <div class="content-column">
        ...
        <p>
            St. Joseph's College maintains a strong research profile with significant contributions to knowledge creation and innovation across disciplines.
        </p>

        <ul>
            <li>Active research centers and laboratories</li>
            <li>Collaborative research partnerships with national and international institutions</li>
            <li>Funded research projects from government and private agencies</li>
            <li>Publication record in peer-reviewed journals and conferences</li>
            <li>Patent applications and innovations</li>
            <li>Recognition and awards for research excellence</li>
        </ul>
    </div>
