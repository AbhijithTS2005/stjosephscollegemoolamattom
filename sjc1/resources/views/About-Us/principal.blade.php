...
<div class="page-container">
    <div class="content-column">
        ...
        <h2 class="section-header">PRINCIPAL</h2>
        <div class="header-underline"></div>

        <div class="bio-text">
            <p>
                    St. Joseph’s College, Moolamattom, which started functioning in 1981 in the backward district of Idukki, has been a noble venture of the Kottayam Province of the CMI congregation in the field of higher education. As the institution is passing through the final decade of its golden jubilee, it has remained faithful to its vision of contributing to the nation a generation of responsible citizens.
                </p>
                <p>
                    The institution stands crowned with the covetous A grade accorded to it by the prestigious national accrediting agency NAAC. It is now blessed with almost all the state-of-the-art facilities necessary to ensure the holistic development of the students.
                </p>
                <p>
                    Teachers are dynamic and well equipped with rich research experience to be the mentors of a future generation. Steps are afoot to obtain the status of autonomy, which we hope will open up new vistas of growth and development.
                </p>
                <p class="font-semibold italic text-blue-900 pt-4">
                    "Success never happens by chance. It is something acquired through meticulous planning and concerted efforts".
                </p>
