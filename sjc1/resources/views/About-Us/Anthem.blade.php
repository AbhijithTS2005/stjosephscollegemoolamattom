...
<div class="page-container">
    <div class="content-column">
        ...
        <h2 class="section-header">ANTHEM</h2>
        <div class="header-underline"></div>

        <div>
                    <p>A lighted lamp on a hill</p>
                    <p>Dispelling darkness around</p>
                    <p>Like a star in the sky</p>
                    <p>Guiding everyone in love</p>
                    <p>Reforming their minds</p>
                    <p>Making everyone new</p>
                    <p>Imparting knowledge and wisdom</p>
                </div>

                <div class="font-bold text-blue-900 not-italic">
                    <p>Hail O’ Hail, St. Joseph’s College</p>
                    <p>A fine abode of love and nurture</p>
                    <p>It’s here we belong</p>
                    <p>Hail O’ Hail, St. Joseph’s College</p>
                    <p>A true mother in every sense</p>
                    <p>We stand for your name</p>
                </div>

                <div>
                    <p>Fill us Lord with your joy and graces</p>
                    <p>Turn us into your helping angels</p>
                    <p>Be with us in all our strivings</p>
                    <p>Make us bloom and flower</p>
                    <p class="text-sm">(Fill us Lord)</p>
                </div>

                <div>
                    <p>Together we play</p>
                    <p>Together we learn</p>
                    <p>To be in the light of truth and justice</p>
                </div>
