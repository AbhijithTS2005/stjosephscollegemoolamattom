        ...
        <div class="bio-text">
            <table class="w-full text-sm text-left border-collapse">
                <tbody class="divide-y divide-gray-200">
                    <tr class="bg-gray-50">
                        <td class="p-4 font-bold text-gray-700 w-1/3">Name of the University</td>
                        <td class="p-4 text-gray-600">St. Joseph’s College Moolamattom (Autonomous)</td>
                    </tr>
                    <tr>
                        <td class="p-4 font-bold text-gray-700">City</td>
                        <td class="p-4 text-gray-600">Moolamattom</td>
                    </tr>
                    <tr class="bg-gray-50">
                        <td class="p-4 font-bold text-gray-700">State</td>
                        <td class="p-4 text-gray-600">Kerala</td>
                    </tr>
                    <tr>
                        <td class="p-4 font-bold text-gray-700">Nation</td>
                        <td class="p-4 text-gray-600">India</td>
                    </tr>
                    <tr class="bg-gray-50">
                        <td class="p-4 font-bold text-gray-700">Status of the college</td>
                        <td class="p-4 text-gray-600">Autonomous</td>
                    </tr>
                    <tr>
                        <td class="p-4 font-bold text-gray-700">Date of University Recognition</td>
                        <td class="p-4 text-gray-600">08-07-2025 under section 3 of UGC Act, 1956</td>
                    </tr>
                    <tr class="bg-gray-50">
                        <td class="p-4 font-bold text-gray-700">Date of establishment</td>
                        <td class="p-4 text-gray-600">06/09/1999</td>
                    </tr>
                    <tr>
                        <td class="p-4 font-bold text-gray-700">Accreditation Details</td>
                        <td class="p-4 text-gray-600">NAAC Reaccredited ‘A++’ Grade, with CGPA 3.78 [2021]</td>
                    </tr>
                    <tr class="bg-gray-50">
                        <td class="p-4 font-bold text-gray-700">Number of Students</td>
                        <td class="p-4 text-gray-600">15000+</td>
                    </tr>
                </tbody>
            </table>
