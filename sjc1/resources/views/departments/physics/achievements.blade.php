        ...
        <main>
            ...
            <div class="content-block">
                <div class="dept-header">
                    <h1>Department Achievements - @deptDisplay($dept)</h1>
                </div>

                <h2>Academic Excellence</h2>
                <p>
                    Our students have consistently achieved top ranks in university examinations and have been recipients of various scholarships and awards.
                </p>
                <ul style="margin-left: 20px;">
                    <li>University rank holders in B.Sc and M.Sc Physics examinations.</li>
                    <li>Recipients of merit scholarships and research fellowships.</li>
                    <li>Students selected for prestigious institutions like IISc, IITs, and TIFR.</li>
                </ul>

                <h2>Research Publications</h2>
                <p>
                    Faculty and students have published research papers in reputed national and international journals.
                </p>
                <ul style="margin-left: 20px;">
                    <li>Publications in journals like Physical Review, Journal of Physics, and Indian Journal of Physics.</li>
                    <li>Presentations at national and international conferences.</li>
                    <li>Research projects funded by UGC, DST, and other agencies.</li>
                </ul>

                <h2>Competitions and Olympiads</h2>
                <p>
                    Students have excelled in various physics competitions and olympiads at state and national levels.
                </p>
                <ul style="margin-left: 20px;">
                    <li>Medals and certificates in National Science Olympiad and Physics Olympiad.</li>
                    <li>Winners in inter-collegiate physics quiz competitions.</li>
                    <li>Participants in International Physics Olympiad training camps.</li>
                </ul>

                <h2>Infrastructure and Facilities</h2>
                <p>
                    The department boasts state-of-the-art laboratories and research facilities.
                </p>
                <ul style="margin-left: 20px;">
                    <li>Modern physics laboratory with advanced equipment.</li>
                    <li>Computational physics lab with high-performance computing facilities.</li>
                    <li>Well-equipped electronics and optics laboratories.</li>
                </ul>

                <div class="eligibility-box">
                    <h3 style="color:var(--college-blue); margin-bottom:10px;">Future Goals</h3>
                    <p>We aim to establish a research center for advanced physics studies, increase industry collaborations, and continue producing outstanding physicists who contribute to scientific advancement.</p>
                </div>
            </div>
        </main>
