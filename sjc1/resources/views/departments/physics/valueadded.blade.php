    ...
    <div class="container">
        ...
        <main>
            ...
            <div class="content-block">
                ...
                <p>
                    The Mathematics department offers various value-added programs to enhance students' skills and employability. These programs are designed to complement the regular curriculum and provide practical exposure to mathematical applications in various fields.
                </p>

                <div class="program-card">
                    <div class="program-title">MATLAB Programming</div>
                    <div class="program-duration">Duration: 30 hours</div>
                    <p>Learn MATLAB for numerical computing, data analysis, and visualization essential for engineering and scientific applications.</p>
                </div>

                <div class="program-card">
                    <div class="program-title">Statistical Computing with R</div>
                    <div class="program-duration">Duration: 40 hours</div>
                    <p>Comprehensive training in R programming for statistical analysis, data mining, and machine learning applications.</p>
                </div>

                <div class="program-card">
                    <div class="program-title">Cryptography and Number Theory</div>
                    <div class="program-duration">Duration: 35 hours</div>
                    <p>Hands-on training in modern cryptography techniques, encryption algorithms, and applications in computer security.</p>
                </div>

                <div class="program-card">
                    <div class="program-title">Mathematical Modeling</div>
                    <div class="program-duration">Duration: 50 hours</div>
                    <p>Learn to develop mathematical models for real-world problems in physics, biology, economics, and engineering.</p>
                </div>

                <div class="eligibility-box">
                    <h3 style="color:var(--college-blue); margin-bottom:10px;">Program Benefits</h3>
                    <p>These programs are offered free of charge to Mathematics students. Successful completion leads to certificates and enhanced job prospects in research and industry. Programs are conducted by faculty members and industry experts.</p>
                </div>
            </div>
        </main>
