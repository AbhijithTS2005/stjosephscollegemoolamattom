    ...
    <div class="container">
        ...
        <main>
            ...
            <div class="content-block">
                ...
                <p>
                    Our Economics students have consistently excelled in academics, securing top ranks in university examinations and winning prizes in inter-college economics quizzes and research competitions. Many have been placed in reputed organizations through our placement drives.
                </p>
                <ul style="margin-left: 20px;">
                    <li>Over 90% placement rate in top economic research firms, banks, and policy institutes.</li>
                    <li>Students winning state-level economics festivals and debates.</li>
                    <li>Internships at economic think tanks, government agencies, and multinational corporations.</li>
                </ul>
                <br>

                <h2>Faculty Achievements</h2>
                <p>
                    Our faculty members are recognized for their contributions to economics education, with publications in national and international journals, and awards for innovative teaching methods.
                </p>
                <ul style="margin-left: 20px;">
                    <li>Publications in reputed journals on topics like macroeconomic analysis and development economics.</li>
                    <li>Awards for best faculty in economics teaching.</li>
                    <li>Participation in national seminars and workshops as resource persons.</li>
                </ul>
                <br>

                <h2>Department Achievements</h2>
                <p>
                    The Department of Economics has been commended for its outstanding performance in placements, research, and industry collaborations, setting high standards in economics education.
                </p>
                <ul style="margin-left: 20px;">
                    <li>Accreditation for excellence in economics programs.</li>
                    <li>MOUs with leading organizations for training and placements.</li>
                    <li>Hosting successful economics seminars and guest lectures by industry experts.</li>
                </ul>
            </div>
        </main>
