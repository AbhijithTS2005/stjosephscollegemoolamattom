        ...
        <main>
            ...
            <div class="content-block">
                <div class="dept-header">
                    <h1>Syllabus & Course Details - Economics Department</h1>
                </div>

                <p>
                    The Economics program offers a comprehensive curriculum designed to provide students with a strong foundation in economic theory, quantitative methods, and policy analysis. The syllabus is structured across six semesters with a mix of core, elective, and skill-based courses.
                </p>

                <div class="semester-section">
                    <h3 class="semester-title">Semester 1</h3>
                    <ul class="course-list">
                        <li class="course-item">Introduction to Economics</li>
                        <li class="course-item">Mathematical Methods for Economics</li>
                        <li class="course-item">English Communication</li>
                        <li class="course-item">Principles of Management</li>
                        <li class="course-item">Computer Applications</li>
                    </ul>
                </div>
                ...
                <div class="semester-section">
                    ...
                    <ul class="course-list">
                        <li class="course-item">Microeconomics</li>
                        <li class="course-item">Statistics for Economics</li>
                        <li class="course-item">Indian Economy</li>
                        <li class="course-item">Business Environment</li>
                        <li class="course-item">Environmental Studies</li>
                    </ul>
                </div>
                ...
                <div class="semester-section">
                    ...
                    <ul class="course-list">
                        <li class="course-item">Macroeconomics</li>
                        <li class="course-item">Economic History</li>
                        <li class="course-item">Public Finance</li>
                        <li class="course-item">Research Methodology</li>
                        <li class="course-item">Development Economics</li>
                    </ul>
                </div>

                <div class="eligibility-box">
                    <h3 style="color:var(--college-blue); margin-bottom:10px;">Course Structure</h3>
                    <p>Each semester consists of 5 core courses and practical sessions. Students must complete 120 credits to graduate. Detailed syllabus documents are available in the department office.</p>
                </div>
            </div>
        </main>
