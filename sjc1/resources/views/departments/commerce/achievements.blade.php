    ...
    <div class="container">
        ...
        <main>
            ...
            <div class="content-block">
                ...
                <p>
                    Our Commerce students have consistently excelled in academics, securing top ranks in university examinations and winning prizes in inter-college commerce quizzes and business plan competitions. Many have been placed in reputed companies through our placement drives.
                </p>
                <ul style="margin-left: 20px;">
                    <li>Over 90% placement rate in top finance and accounting firms.</li>
                    <li>Students winning state-level commerce festivals and debates.</li>
                    <li>Internships at banks, CA firms, and multinational corporations.</li>
                </ul>
                <br>

                <h2>Faculty Achievements</h2>
                <p>
                    Our faculty members are recognized for their contributions to commerce education, with publications in national and international journals, and awards for innovative teaching methods.
                </p>
                <ul style="margin-left: 20px;">
                    <li>Publications in reputed journals on topics like financial analysis and entrepreneurship.</li>
                    <li>Awards for best faculty in commerce teaching.</li>
                ...
                <p>
                    The Department of Commerce has been commended for its outstanding performance in placements, research, and industry collaborations, setting high standards in commerce education.
                </p>
                <ul style="margin-left: 20px;">
                    <li>Accreditation for excellence in commerce programs.</li>
                    <li>MOUs with leading companies for training and placements.</li>
                    <li>Hosting successful commerce seminars and guest lectures by industry experts.</li>
                </ul>
            </div>
        </main>
