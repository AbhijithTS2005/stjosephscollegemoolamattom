    ...
    <div class="container">
        ...
        <main>
            ...
            <div class="content-block">
                ...
                <p>
                    The Commerce program offers a comprehensive curriculum designed to provide students with a strong foundation in commerce and business. The syllabus is structured across six semesters with a mix of core, elective, and skill-based courses.
                </p>

                <div class="semester-section">
                    <h3 class="semester-title">Semester 1</h3>
                    <ul class="course-list">
                        <li class="course-item">Financial Accounting</li>
                        <li class="course-item">Business Mathematics</li>
                        <li class="course-item">Business Communication</li>
                        <li class="course-item">Principles of Management</li>
                        <li class="course-item">Computer Applications in Business</li>
                    </ul>
                </div>
                ...
                <div class="semester-section">
                    ...
                    <ul class="course-list">
                        <li class="course-item">Corporate Accounting</li>
                        <li class="course-item">Business Statistics</li>
                        <li class="course-item">Business Law</li>
                        <li class="course-item">Organizational Behavior</li>
                        <li class="course-item">E-Commerce</li>
                    </ul>
                </div>
                ...
                <div class="semester-section">
                    ...
                    <ul class="course-list">
                        <li class="course-item">Cost Accounting</li>
                        <li class="course-item">Marketing Management</li>
                        <li class="course-item">Financial Management</li>
                        <li class="course-item">Business Ethics</li>
                        <li class="course-item">Entrepreneurship Development</li>
                    </ul>
                </div>
