        ...
        <main>
            ...
            <div class="content-block">
                <div class="dept-header">
                    <h1>Achievements - Data Science Department</h1>
                </div>

                <h2>Student Achievements</h2>
                <p>
                    Our Data Science students have excelled in various competitions, hackathons, and research projects. They have won prizes in national-level data science challenges and secured internships at leading tech companies.
                </p>
                <ul style="margin-left: 20px;">
                    <li>Multiple winners in Kaggle competitions and data science hackathons.</li>
                    <li>Students published research papers in reputed journals.</li>
                    <li>High placement rate in top tech companies like Google, Amazon, and Microsoft.</li>
                    <li>Recipients of prestigious scholarships and fellowships.</li>
                </ul>

                <h2>Faculty Achievements</h2>
                <p>
                    Our faculty members have received recognition for their research contributions in machine learning, big data analytics, and AI applications.
                </p>
                <ul style="margin-left: 20px;">
                    <li>Published papers in IEEE and ACM conferences.</li>
                    <li>Received research grants from government agencies.</li>
                    <li>Awarded best teacher and researcher titles.</li>
                </ul>

                <h2>Department Achievements</h2>
                <p>
                    The department has been recognized for its innovative curriculum and industry partnerships.
                </p>
                <ul style="margin-left: 20px;">
                    <li>Accredited by leading tech organizations.</li>
                    <li>Established Center of Excellence in Data Science.</li>
                    <li>Organized international conferences and workshops.</li>
                </ul>

                <div class="eligibility-box">
                    <h3 style="color:var(--college-blue); margin-bottom:10px;">Future Goals</h3>
                    <p>Continue to foster innovation in data science education and research, aiming for global recognition and leadership in the field.</p>
                </div>
            </div>
        </main>
