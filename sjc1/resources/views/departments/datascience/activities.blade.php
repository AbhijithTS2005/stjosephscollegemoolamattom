        ...
        <main>
            ...
            <div class="content-block">
                <div class="dept-header">
                    <h1>Department Activities - Data Science</h1>
                </div>

                <h2>Workshops and Seminars</h2>
                <p>
                    The department regularly organizes workshops on emerging technologies, guest lectures by industry experts, and seminars on current trends in data science.
                </p>
                <ul style="margin-left: 20px;">
                    <li>Monthly workshops on Python, R, and machine learning tools.</li>
                    <li>Annual Data Science Summit with keynote speakers from tech giants.</li>
                    <li>Industry-academia interaction sessions.</li>
                </ul>

                <h2>Student Clubs and Competitions</h2>
                <p>
                    Active student clubs promote practical learning through projects, hackathons, and competitions.
                </p>
                <ul style="margin-left: 20px;">
                    <li>Data Science Club organizes coding challenges and project showcases.</li>
                    <li>Participation in national and international hackathons.</li>
                    <li>Inter-departmental data analytics competitions.</li>
                </ul>

                <h2>Research and Publications</h2>
                <p>
                    Faculty and students engage in research activities leading to publications and patents.
                </p>
                <ul style="margin-left: 20px;">
                    <li>Research projects in AI and big data applications.</li>
                    <li>Publications in peer-reviewed journals and conferences.</li>
                    <li>Collaboration with research institutions.</li>
                </ul>

                <h2>Industry Partnerships</h2>
                <p>
                    Strong ties with industry partners provide students with real-world exposure.
                </p>
                <ul style="margin-left: 20px;">
                    <li>Internship programs with leading tech companies.</li>
                    <li>Industry-sponsored projects and certifications.</li>
                    <li>Guest lectures and mentorship programs.</li>
                </ul>

                <div class="eligibility-box">
                    <h3 style="color:var(--college-blue); margin-bottom:10px;">Upcoming Events</h3>
                    <p>Check the department notice board or website for upcoming workshops, seminars, and competitions. Student participation is highly encouraged.</p>
                </div>
            </div>
        </main>
