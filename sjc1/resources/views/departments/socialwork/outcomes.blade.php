    ...
    <div class="container">
        ...
        <main>
            ...
            <div class="content-block">
                ...
                <p>
                    The Mathematics program is designed to achieve specific learning outcomes that prepare students for successful careers in mathematics, research, and related fields. These outcomes are categorized into Program Outcomes (PO), Program Specific Outcomes (PSO), and Course Outcomes (CO).
                </p>
                ...
                <div class="outcome-section">
                    ...
                    <ul class="outcome-list">
                        <li class="outcome-item">
                            ...
                            <p>Demonstrate proficiency in mathematical concepts and theories.</p>
                        </li>
                        <li class="outcome-item">
                            <div class="outcome-code">PO2:</div>
                            <p>Apply mathematical methods to solve real-world problems.</p>
                        </li>
                        <li class="outcome-item">
                            <div class="outcome-code">PO3:</div>
                            <p>Develop logical reasoning and analytical thinking skills.</p>
                        </li>
                        <li class="outcome-item">
                            <div class="outcome-code">PO4:</div>
                            <p>Use computational tools effectively in mathematical analysis.</p>
                        </li>
                    </ul>
                </div>
                ...
                <div class="outcome-section">
                    ...
                    <ul class="outcome-list">
                        <li class="outcome-item">
                            ...
                            <p>Conduct mathematical research and present findings effectively.</p>
                        </li>
                        <li class="outcome-item">
                            <div class="outcome-code">PSO2:</div>
                            <p>Apply advanced mathematical techniques in interdisciplinary contexts.</p>
                        </li>
                        <li class="outcome-item">
                            <div class="outcome-code">PSO3:</div>
                            <p>Develop computational models for complex mathematical problems.</p>
                        </li>
                    </ul>
                </div>
                ...
                <div class="outcome-section">
                    ...
                    <ul class="outcome-list">
                        <li class="outcome-item">
                            ...
                            <p>Understand fundamental concepts in calculus and algebra.</p>
                        </li>
                        <li class="outcome-item">
                            <div class="outcome-code">CO2:</div>
                            <p>Apply statistical methods to data analysis and interpretation.</p>
                        </li>
                        <li class="outcome-item">
                            <div class="outcome-code">CO3:</div>
                            <p>Communicate mathematical ideas clearly and precisely.</p>
                        </li>
                    </ul>
                </div>
                ...
                <div class="eligibility-box">
                    ...
                    <p>Student progress is continuously assessed through problem-solving assignments, mathematical proofs, projects, and examinations aligned with these outcomes.</p>
                </div>
            </div>
        </main>
