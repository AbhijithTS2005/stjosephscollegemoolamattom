        ...
        <main>
            ...
            <div class="content-block">
                <div class="dept-header">
                    <h1>Value Added Programs - B.Com Department</h1>
                </div>

                <p>
                    The B.Com department offers various value-added programs to enhance students' skills and employability. These programs are designed to complement the regular curriculum and provide practical exposure to industry practices.
                </p>

                <div class="program-card">
                    <div class="program-title">Advanced Excel & Data Analysis</div>
                    <div class="program-duration">Duration: 30 hours</div>
                    <p>Learn advanced Excel functions, data visualization, and business analytics tools essential for modern business environments.</p>
                </div>

                <div class="program-card">
                    <div class="program-title">Digital Marketing Workshop</div>
                    <div class="program-duration">Duration: 40 hours</div>
                    <p>Comprehensive training in SEO, social media marketing, content creation, and online advertising strategies.</p>
                </div>

                <div class="program-card">
                    <div class="program-title">Financial Modeling</div>
                    <div class="program-duration">Duration: 35 hours</div>
                    <p>Hands-on training in building financial models, investment analysis, and corporate valuation techniques.</p>
                </div>

                <div class="program-card">
                    <div class="program-title">Entrepreneurship Development</div>
                    <div class="program-duration">Duration: 50 hours</div>
                    <p>Learn business planning, startup management, and entrepreneurial skills through real-world case studies.</p>
                </div>

                <div class="eligibility-box">
                    <h3 style="color:var(--college-blue); margin-bottom:10px;">Program Benefits</h3>
                    <p>These programs are offered free of charge to B.Com students. Successful completion leads to certificates and enhanced job prospects. Programs are conducted by industry experts and faculty members.</p>
                </div>
            </div>
        </main>
