    ...
    <div class="container">
        <main>
            <div class="content-block">
                ...
                <h3 style="color: var(--college-blue); margin: 20px 0 15px 0;">Vision</h3>
                <p>To be recognized as a center of excellence in research, innovation, and education, developing graduates who contribute positively to society and advance knowledge in their respective fields.</p>
                
                <h3 style="color: var(--college-blue); margin: 20px 0 15px 0;">Mission</h3>
                <p>Our mission is to:</p>
                <ul style="margin-left: 20px; margin-top: 10px;">
                    <li>Provide high-quality education and training</li>
                    <li>Foster intellectual curiosity and critical thinking</li>
                    <li>Promote research and innovation</li>
                    <li>Develop responsible global citizens</li>
                    <li>Support career development and professional growth</li>
                </ul>
                
                <h3 style="color: var(--college-blue); margin: 20px 0 15px 0;">Goals</h3>
                <p>We strive to equip students with the knowledge, skills, and values necessary to excel in their careers and make meaningful contributions to their communities.</p>
            </div>
        </main>

        
                @include('partials.department-sidebar', ['dept' => $dept, 'page' => 'visionmission'])
