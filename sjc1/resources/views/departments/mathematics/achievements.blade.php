        ...
        <main>
            ...
            <div class="content-block">
                <div class="dept-header">
                    <h1>Achievements - Mathematics Department</h1>
                </div>

                <h2>Student Achievements</h2>
                <p>
                    Our Mathematics students have consistently excelled in academics, securing top ranks in university examinations and winning prizes in inter-college mathematics competitions, Olympiads, and research presentations. Many have pursued advanced studies and research positions.
                </p>
                <ul style="margin-left: 20px;">
                    <li>Students qualifying for national and international mathematics Olympiads.</li>
                    <li>Success in university rank holders and gold medalists.</li>
                    <li>Internships and research positions at premier institutions and tech companies.</li>
                </ul>
                <br>

                <h2>Faculty Achievements</h2>
                <p>
                    Our faculty members are recognized for their contributions to mathematics education and research, with publications in international journals, research grants, and awards for excellence in teaching and research.
                </p>
                <ul style="margin-left: 20px;">
                    <li>Publications in reputed international journals on pure and applied mathematics.</li>
                    <li>Research grants from national funding agencies.</li>
                    <li>Participation in international conferences and workshops as keynote speakers.</li>
                </ul>
                <br>

                <h2>Department Achievements</h2>
                <p>
                    The Department of Mathematics has been commended for its outstanding performance in research output, student placements in academia and industry, and contributions to mathematical sciences.
                </p>
                <ul style="margin-left: 20px;">
                    <li>Recognition for excellence in mathematics education and research.</li>
                    <li>Collaborations with research institutions and industry partners.</li>
                    <li>Hosting successful mathematics seminars, workshops, and guest lectures by eminent mathematicians.</li>
                </ul>
            </div>
        </main>
