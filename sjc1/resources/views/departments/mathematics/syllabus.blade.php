    ...
    <div class="container">
        ...
        <main>
            ...
            <div class="content-block">
                ...
                <p>
                    The Mathematics program offers a comprehensive curriculum designed to provide students with a strong foundation in pure and applied mathematics. The syllabus is structured across six semesters with a mix of core, elective, and skill-based courses.
                </p>

                <div class="semester-section">
                    <h3 class="semester-title">Semester 1</h3>
                    <ul class="course-list">
                        <li class="course-item">Calculus I</li>
                        <li class="course-item">Linear Algebra</li>
                        <li class="course-item">Discrete Mathematics</li>
                        <li class="course-item">Mathematical Methods</li>
                        <li class="course-item">Computer Programming for Mathematicians</li>
                    </ul>
                </div>
                ...
                <div class="semester-section">
                    ...
                    <ul class="course-list">
                        <li class="course-item">Calculus II</li>
                        <li class="course-item">Abstract Algebra</li>
                        <li class="course-item">Differential Equations</li>
                        <li class="course-item">Probability Theory</li>
                        <li class="course-item">Numerical Methods</li>
                    </ul>
                </div>
                ...
                <div class="semester-section">
                    ...
                    <ul class="course-list">
                        <li class="course-item">Real Analysis</li>
                        <li class="course-item">Complex Analysis</li>
                        <li class="course-item">Topology</li>
                        <li class="course-item">Statistics</li>
                        <li class="course-item">Mathematical Modeling</li>
                    </ul>
                </div>
